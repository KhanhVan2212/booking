...
export default function PolicyPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      {/* 1. HERO HEADER */}
      <div className="mt-[72px] bg-gradient-to-r from-red-800 to-red-600 py-16 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-red-100">
            ...
            bảo mật thông tin của Hà Anh JSC.
          </p>
        </div>
      </div>
            ...
            <div className="sticky top-28 rounded-xl border border-slate-100 bg-white p-6 shadow-sm">
              ...
              <ul className="space-y-3 text-sm font-medium text-slate-600">
                <li
                  ...
                  className="flex cursor-pointer items-center gap-2 transition hover:translate-x-1 hover:text-red-600"
                >
          ...
          <div className="space-y-12 lg:col-span-3">
            ...
            <section id="step-1" className="scroll-mt-28">
              <h2 className="mb-6 flex items-center gap-3 border-b border-slate-200 pb-4 text-2xl font-bold text-slate-800">
                <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-red-100 text-lg text-red-600">
                  <FaRightLeft />
                </span>
                I. Các bước đổi vé máy bay
              </h2>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="group relative overflow-hidden rounded-xl border border-slate-100 bg-white p-6 shadow-sm transition hover:border-red-200">
                  ...
                  <p className="text-slate-600">
                    Truy cập vào website chính thức của Hà Anh JSC để tra cứu
                    thông tin vé.
                  </p>
                </div>
                <div className="group relative overflow-hidden rounded-xl border border-slate-100 bg-white p-6 shadow-sm transition hover:border-red-200">
                  <div className="absolute right-0 top-0 rounded-bl-lg bg-red-100 px-3 py-1 text-xs font-bold text-red-600">
                    Bước 2
                  </div>
                  <h3 className="mb-2 text-lg font-bold text-slate-800">
                    Liên hệ nhân viên
                  ...
                  <div className="flex flex-col gap-2">
                    <a
                      ...
                      className="flex w-fit items-center gap-2 rounded-full bg-red-50 px-3 py-1 font-bold text-red-600 hover:bg-red-100"
                    >
                      <FaPhone className="text-sm" /> 024 3771 4566
                    </a>
                    <a
                      href="tel:0967861990"
                      className="flex w-fit items-center gap-2 rounded-full bg-red-50 px-3 py-1 font-bold text-red-600 hover:bg-red-100"
                    >
                      <FaPhone className="text-sm" /> 096 786 1990
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-slate-100 bg-white p-8 shadow-sm">
                <ul className="space-y-4">
                  <li className="flex items-start gap-3 text-slate-700">
                    <FaCircleCheck className="mt-1 flex-shrink-0 text-red-500" />
                    <span>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <section id="step-3" className="scroll-mt-28">
                <div className="h-full rounded-xl border border-slate-100 bg-white p-6 shadow-sm transition hover:shadow-md">
                  <h3 className="mb-4 flex items-center gap-2 border-b pb-2 text-lg font-bold text-slate-800">
                    <FaRightLeft className="text-red-500" /> III. Điều kiện đổi
                    vé
                  </h3>
                  <ul className="space-y-3 text-sm text-slate-600">
                    <li className="flex gap-2">
                      <FaArrowRight className="mt-1 text-xs text-red-400" /> Áp
                      dụng cho các hạng vé cho phép đổi.
                    </li>
                    <li className="flex gap-2">
                      <FaArrowRight className="mt-1 text-xs text-red-400" />{" "}
                      Thực hiện tối thiểu trước 03 giờ so với giờ khởi hành.
                    </li>
                    <li className="flex gap-2">
                      <FaArrowRight className="mt-1 text-xs text-red-400" /> Chỉ
                      đổi sang hành trình/loại vé có giá bằng hoặc cao hơn vé
                      ban đầu.
                    </li>
                  </ul>
                </div>
              ...
              <section id="step-4" className="scroll-mt-28">
                <div className="h-full rounded-xl border border-slate-100 bg-white p-6 shadow-sm transition hover:shadow-md">
                  <h3 className="mb-4 flex items-center gap-2 border-b pb-2 text-lg font-bold text-slate-800">
                    <FaRightLeft className="text-red-500" /> IV. Hoàn vé & Hủy
                    vé
                  </h3>
                  <ul className="space-y-3 text-sm text-slate-600">
                    <li className="flex gap-2">
                      <FaArrowRight className="mt-1 text-xs text-red-400" /> Áp
                      dụng cho vé có điều kiện hoàn vé.
                    </li>
                    <li className="flex gap-2">
                      <FaArrowRight className="mt-1 text-xs text-red-400" /> Vé
                      phải chưa được sử dụng hoặc mới sử dụng một phần.
                    </li>
                    <li className="flex gap-2">
                      <FaArrowRight className="mt-1 text-xs text-red-400" /> Phí
                      hoàn vé sẽ được tính theo quy định của hãng hàng không.
                    </li>
                  </ul>
                </div>
              </section>
            ...
            <section id="step-5" className="scroll-mt-28">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="rounded-xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-6">
                  ...
                  <p className="text-sm text-slate-600">
                    Đến trực tiếp văn phòng Hà Anh JSC tại 63 Mai Hắc Đế.
                  </p>
            ...
            <section id="step-6" className="scroll-mt-28">
              ...
              <div className="space-y-6 rounded-xl border border-slate-100 bg-white p-8 shadow-sm">
                <div>
                  <h4 className="mb-2 text-lg font-bold text-red-600">
                ...
                <div>
                  ...
                  <p className="text-justify text-sm leading-relaxed text-slate-600">
                    ...
                    Những loại thông tin khác giúp Hà Anh lập hồ sơ cá nhân về
